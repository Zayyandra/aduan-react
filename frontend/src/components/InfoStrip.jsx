...
const DIST = {
  kesehatan: 4513, transportasi: 4431, administrasi: 4165,
  infrastruktur: 4155, pendidikan: 2318, kebersihan: 1485,
};
const TOTAL = 21067;
const SENTI = [
  { label: "Negatif",  n: 11514, pct: 54.7, c: "#dc2626" },
  { label: "Positif",  n: 8424,  pct: 40.0, c: "#16a34a" },
  { label: "Netral",   n: 1129,  pct: 5.4,  c: "#94a3b8" },
];
  ...
  return (
    <div className="mt-12">
      <div className="text-center max-w-[620px] mx-auto mb-12">
        ...
        <p className="reveal text-[#475467] text-[16px] font-medium" style={{ transitionDelay:"0.16s" }}>Dikumpulkan dari 14 aplikasi layanan publik pemerintah di Google Play Store. Label sentimen otomatis dari rating bintang.</p>
      </div>
      ...
      <div className="grid lg:grid-cols-[1.25fr_1fr] gap-5">
        <div className="reveal-left card-lift bg-white border border-[#d4e5e2] rounded-[18px] p-6 shadow-sm">
          <div className="flex items-center justify-between mb-5">
            ...
            <div className="font-mono text-[12px] text-[#7d918d]">n = 21.067</div>
          </div>
        ...
        <div className="reveal-right card-lift bg-white border border-[#d4e5e2] rounded-[18px] p-6 shadow-sm" style={{ transitionDelay:"0.12s" }}>
          ...
          <div className="mt-5 bg-[#e6f7f5] border border-[#ccefeb] rounded-[11px] px-4 py-3.5 text-[14px] text-[#0c5b54] leading-snug">
            <b className="text-[#0d5c56]">Catatan jujur:</b> label otomatis dari rating bintang Play Store: ★1–2 = negatif, ★3 = netral, ★4–5 = positif. Tidak menggunakan model sentimen terlatih terpisah.
          </div>
        </div>
      </div>
    </div>
