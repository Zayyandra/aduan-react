  ...
  return (
    <div className="mt-12">
      <div className="text-center max-w-[620px] mx-auto mb-12">
        ...
        <p className="reveal text-[#475467] text-[16px] font-medium" style={{ transitionDelay:"0.16s" }}>Dikumpulkan mandiri dari X (Twitter) via tweet-harvest, lalu disaring bertingkat dan dilabeli leksikon.</p>
      </div>
      ...
      <div className="grid lg:grid-cols-[1.25fr_1fr] gap-5">
        ...
        <div className="reveal-right card-lift bg-white border border-[#d4e5e2] rounded-[18px] p-6 shadow-sm" style={{ transitionDelay:"0.12s" }}>
          ...
          <div className="mt-5 bg-[#e6f7f5] border border-[#ccefeb] rounded-[11px] px-4 py-3.5 text-[14px] text-[#0c5b54] leading-snug">
            <b className="text-[#0d5c56]">Catatan jujur:</b> sentimen sangat timpang ke netral — konsekuensi pelabelan leksikon post-scraping.
          </div>
        </div>
      </div>
    </div>
